...
class RolesController < ApplicationController
  ...
  def init_sheet
    ...
    @sheet_detail_fields = ''
    @sheet_fields_no_id = ":code, :name, :remarks"
    @sheet_fields_no_id_params = ":code => params[:code], :name => params[:name], :remarks => params[:remarks]"
    @sheet_fields_type = "code:text_field name:text_field remarks:text_area "
  end
  ...
  def post_data
    ...
    if params[:oper] == "del"
      ...
      if params[:id] == "_empty"
        record = Role.create(record_params)
      else
